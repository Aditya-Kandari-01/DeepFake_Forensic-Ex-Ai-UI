...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-gray-200 p-4">
      ...
      <div className="max-w-md w-full bg-white/10 backdrop-blur-md rounded-xl p-6 shadow-lg ring ring-gray-800/50">
        ...
        {result && (
          <ResultCard probability={result.probability} prediction={result.prediction} />
        )}
      </div>
      <ModelStats />
    </div>
